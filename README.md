...
Sharing the concept of using notation to create code with ChatGPT is the real value of this document. Customize Settings, add new keywords and code patterns to create your own personalized GPT-HTML notation. I imagine every developer creating a customised GPT notation that fits their process and preferences. I realize now that every developer will create their own productivity tools to use in ChatGPT. Let's get started!
